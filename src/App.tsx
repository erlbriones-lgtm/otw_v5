...
export default function App() {
  ...
  const getBackgroundStyle = () => {
    ...
    switch (activeView) {
      case "home":
        // Rich high-contrast cosmic violet, luminous orchid purple, and royal electric blue
      ...
      case "about":
        // Fiery sunset crimson, deep terracotta orange, royal gold, and glowing sun-kissed yellow
        return "linear-gradient(135deg, #820303 0%, #b82b04 35%, #e14e0e 70%, #ea850b 100%)";
      default:
        return "linear-gradient(135deg, #19053a 0%, #3e1273 35%, #5e269c 70%, #0d4eb0 100%)";
    }
  };
  ...
  const getFooterBackgroundStyle = () => {
    ...
    switch (activeView) {
      case "home":
        return "#090214"; // Deep cosmic space
      case "heritage":
      ...
      case "about":
        return "#170500"; // Match deep sunset terracotta
      default:
        return "#090214";
    }
  };
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none z-0" id="ambient-layers-luminous">
        {activeView === "home" && !selectedDetailedHeritageId && (
          <>
            <div className="absolute top-[-5%] left-[-10%] w-[650px] h-[650px] rounded-full blur-[140px] animate-float-1" style={{ background: "rgba(138, 43, 226, 0.2)" }} />
            <div className="absolute bottom-[20%] right-[-5%] w-[600px] h-[600px] rounded-full blur-[140px] animate-float-2" style={{ background: "rgba(30, 144, 255, 0.22)" }} />
            <div className="absolute top-[40%] left-[20%] w-[500px] h-[500px] rounded-full blur-[130px] animate-float-1" style={{ background: "rgba(255, 69, 0, 0.12)" }} />
          </>
        )}
        ...
        {activeView === "about" && !selectedDetailedHeritageId && (
          <>
            <div className="absolute top-[-5%] left-[-10%] w-[650px] h-[650px] rounded-full blur-[140px] animate-float-1" style={{ background: "rgba(216, 67, 21, 0.26)" }} />
            <div className="absolute bottom-[20%] right-[-5%] w-[600px] h-[600px] rounded-full blur-[140px] animate-float-2" style={{ background: "rgba(251, 192, 45, 0.24)" }} />
            <div className="absolute top-[40%] left-[20%] w-[500px] h-[500px] rounded-full blur-[130px] animate-float-1" style={{ background: "rgba(230, 74, 25, 0.22)" }} />
          </>
        )}
                  ...
                  <div className="lg:col-span-5 flex flex-col gap-4 max-h-[580px] overflow-y-auto pr-2 scrollbar-thin" id="bento-sidebar">
                    {filteredLandmarks.map((landmark) => (
                      <div
                        ...
                        className={`p-5 rounded-2xl border text-left cursor-pointer transition-all duration-350 relative overflow-hidden group backdrop-blur-md ${
                          activeLandmark?.id === landmark.id
                            ? "bg-[rgba(255,255,255,0.25)] border-[rgba(255,255,255,0.3)] shadow-xl scale-[1.01] text-white"
                            : "bg-[rgba(0,0,0,0.25)] border-[rgba(255,255,255,0.15)] hover:bg-[rgba(255,255,255,0.12)] text-white"
                        }`}
                      >
                        <div className="flex justify-between items-start gap-4">
                          <div>
                            <span className="inline-block px-2.5 py-0.5 rounded text-[9px] font-mono uppercase tracking-widest font-bold mb-2 bg-[rgba(255,255,255,0.2)] text-white border border-[rgba(255,255,255,0.3)] badge-tag-custom">
                              {landmark.category}
                            </span>
                            <h3 className="font-display font-black text-white tracking-tight text-lg group-hover:text-white transition-colors mt-1">
                              {landmark.title}
                            </h3>
                            <p className="text-white text-xs line-clamp-2 mt-1.5 leading-relaxed font-sans font-medium">
                              {landmark.description}
                            </p>
                          </div>
                          <ChevronRight className={`w-4 h-4 mt-1.5 transition-transform text-white ${
                            activeLandmark?.id === landmark.id 
                              ? "translate-x-1" 
                    ...
                    <AnimatePresence mode="wait">
                      {activeLandmark && (
                        <motion.div
                          ...
                          className="h-full rounded-2xl border border-[rgba(255,255,255,0.15)] bg-[rgba(0,0,0,0.25)] backdrop-blur-md overflow-hidden flex flex-col shadow-xl text-left text-white glass-panel-custom"
                        >
                          <div className="relative h-64 w-full bg-black/10 overflow-hidden">
                            <img 
                            ...
                            <div className="absolute top-4 right-4">
                              <span className="px-3 py-1 rounded-full bg-[rgba(255,255,255,0.2)] backdrop-blur-sm text-[10px] uppercase font-mono tracking-widest text-[#FFD54F] border border-[rgba(255,255,255,0.3)] flex items-center gap-1.5 font-bold badge-tag-custom">
